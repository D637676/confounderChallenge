...
# Doc Dreamy annotation with ○ symbol
ax.text(x_annotation, dreamy_mean, f'○ Mean = {dreamy_mean:.2f}', 
        fontsize=11, color='#4E79A7', weight='bold', 
        verticalalignment='center', horizontalalignment='right', zorder=4)

# Doc Duck annotation with △ symbol
ax.text(x_annotation, duck_mean, f'△ Mean = {duck_mean:.2f}', 
        fontsize=11, color='#E15759', weight='bold', 
        verticalalignment='center', horizontalalignment='right', zorder=4)
...
# Add legend (excluding the shaded region from legend to keep it clean)
handles, labels = ax.get_legend_handles_labels()
# Filter out the shaded region from legend
filtered_handles = [h for h, l in zip(handles, labels) if l != 'Stratification Region']
filtered_labels = [l for l in labels if l != 'Stratification Region']
